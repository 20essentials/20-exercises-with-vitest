...
import { canReconfigure } from './exercise-15.js';
...
describe('canReconfigure', () => {
  ...
  it('should throw specific error messages if any parameter is not a string', () => {
    expect(() => canReconfigure(2)).toThrow('"from" parameter must be a string');
    expect(() => canReconfigure('from', 2)).toThrow(
      '"to" parameter must be a string'
    );
  });
  ...
  it(
    'should return "false" if strings have same number of unique letters ' +
